...
@Database(entities = [ProductiveDay::class], version = 1, exportSchema = false)
abstract class ProductivityDatabase : RoomDatabase() {

    /**
     * Connects the database to the DAO.
     */
    abstract val productivityDatabaseDao: ProductivityDatabaseDao
    ...
    companion object {
        ...
        fun getInstance(context: Context): ProductivityDatabase {
